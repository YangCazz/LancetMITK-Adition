...
namespace lancetAlgorithm
{
	...
	public:
		...
		/// <param name="planeNormal"></param>
		/// <returns></returns>
		vtkSmartPointer<vtkMatrix4x4> CalculateDrillEndVerticalPlane(Eigen::Vector3d pointInPlane, Eigen::Vector3d planeNormal);
		...
		double GetDrillTip2DrillPlaneDistance(Eigen::Vector3d planePoint, Eigen::Vector3d planeNormal);
