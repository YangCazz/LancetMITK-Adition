...
vtkSmartPointer<vtkMatrix4x4> PKAData::m_TBase2BaseRF = vtkSmartPointer<vtkMatrix4x4>::New();
vtkSmartPointer<vtkMatrix4x4> PKAData::m_TFlange2EndRF = vtkSmartPointer<vtkMatrix4x4>::New();
vtkSmartPointer<vtkMatrix4x4> PKAData::m_TBase2End = vtkSmartPointer<vtkMatrix4x4>::New();
...
vtkSmartPointer<vtkMatrix4x4> PKAData::m_TCmaera2Drill = vtkSmartPointer<vtkMatrix4x4>::New();
